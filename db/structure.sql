...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@djgbedu\.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20160902092233'), ('20160902190825'), ('20160902225219'), ('20160903073836');
